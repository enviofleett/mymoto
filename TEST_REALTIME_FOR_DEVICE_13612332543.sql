-- Test realtime updates for device 13612332543
-- This will manually trigger a database update to test if Realtime is working
...
-- This simulates what the GPS sync job does
UPDATE vehicle_positions
SET 
  latitude = COALESCE(latitude, 0) + 0.0001,  -- Move slightly (if null, use 0)
...
-- If you're viewing the vehicle profile page for this device in the browser,

-- Migration: Fix get_vehicle_trips_optimized type mismatch
-- Description: Cast numeric columns to double precision to match return type
...
BEGIN
  ...
  SELECT
    ...
    vt.end_latitude,
    vt.end_longitude,
    vt.max_speed::DOUBLE PRECISION, -- Cast to match return type
    vt.avg_speed::DOUBLE PRECISION, -- Cast to match return type
    vt.source

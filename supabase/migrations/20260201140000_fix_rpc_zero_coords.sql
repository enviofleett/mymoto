-- Migration: Fix RPC Zero Coordinate Handling
-- Description:
-- Updates get_vehicle_trips_optimized to ignore 0.0 coordinates when aggregating start/end locations.
-- This prevents trips from showing as 0.0,0.0 (Null Island) if the device sends invalid data
-- at the very beginning/end of a trip, but has valid data in between.
